...
This project contains the Pytorch layer C++ and Python layer code for supporting the [IBM Spyre device](https://www.ibm.com/new/announcements/ibm-spyre-accelerator-and-telum-ii-processor-capturing-ai-value-at-a-trusted-enterprise-level) as a new device, named `spyre`, in PyTorch.

...
def tile_spec_to_dim_hints(
    ...
    :func:`resolve_tile_axis_loop_vars`, shared with
    ``wsr.tile_prediction._validate_tiling`` so that what the predictor prices is
    exactly what this function can lower. Only the ``hint_ids`` pairing, which
    prediction has no analogue for, lives here.
    """
